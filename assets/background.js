...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _saveCoords = __webpack_require__(220);
	...
	var app = (0, _cerebral.Module)({
	  ...
	  signals: {
	    saveCoords: _saveCoords2.default,
	    ...
	    removeCard: _removeCard2.default,
	    dockCard: _dockCard2.default,
	    undockCard: _undockCard2.default
	  }
	});
	...
	controller.on('mutation', function (mutation) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _addToCards = __webpack_require__(176);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _operators = __webpack_require__(177);

	var uuidv4 = __webpack_require__(173);
	exports.default = [function addToCards(_ref) {
	  var state = _ref.state,
	      props = _ref.props;
	...
	}, function getHtmlFromToolTipEndPoint(_ref2) {
	  var http = _ref2.http;
	}];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _httpDelete = __webpack_require__(179);
	...
	var _httpGet = __webpack_require__(182);
	...
	var _httpPatch = __webpack_require__(183);
	...
	var _httpPost = __webpack_require__(184);
	...
	var _httpPut = __webpack_require__(185);
	...
	var _httpUploadFile = __webpack_require__(186);
	...
	var _httpAbort = __webpack_require__(187);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function httpDeleteFactory(url) {
	  ...
	  function httpDelete(_ref) {
	    ...
	    return (0, _utils.processResponse)(http.delete(resolve.value(url), resolve.value(query), options), path);
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _HttpProviderError = __webpack_require__(181);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function httpGetFactory(url) {
	  ...
	  function httpGet(_ref) {
	    ...
	    return (0, _utils.processResponse)(http.get(resolve.value(url), resolve.value(query), options), path);
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function httpPostFactory(url) {
	  ...
	  function httpPost(_ref) {
	    ...
	    return (0, _utils.processResponse)(http.post(resolve.value(url), resolve.value(body), options), path);
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function httpPutFactory(url) {
	  ...
	  function httpPut(_ref) {
	    ...
	    return (0, _utils.processResponse)(http.put(resolve.value(url), resolve.value(body), options), path);
	  }
...
/***/ (function(module, exports) {
	...
	exports.default = httpAbortFactory;
	//# sourceMappingURL=httpAbort.js.map
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _debounce = __webpack_require__(195);
	...
	var _wait = __webpack_require__(199);
	...
	var _concat = __webpack_require__(201);
	...
	var _increment = __webpack_require__(202);
	...
	var _shift = __webpack_require__(207);
	...
	var _splice = __webpack_require__(208);
	...
	var _toggle = __webpack_require__(209);
	...
	var _unset = __webpack_require__(210);
	...
	var _unshift = __webpack_require__(211);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _factories = __webpack_require__(196);
...
/***/ (function(module, exports) {
	...
	exports.default = [function saveCoords(_ref) {
	  var state = _ref.state,
	      props = _ref.props;
...
/***/ (function(module, exports) {
	...
	exports.default = [function removeCard(_ref) {
	  var state = _ref.state,
	      props = _ref.props;

	  var card = state.get('cards');
...
/***/ (function(module, exports) {
	...
	exports.default = [function dockCard(_ref) {
	  var state = _ref.state,
	      props = _ref.props;
...
/***/ (function(module, exports) {
	...
	exports.default = [function undockCard(_ref) {
	  var state = _ref.state,
	      props = _ref.props;
